...
function armSimulation() {
 ...
 // console.log("arm_angle",(arm_angle))
  //console.log("deltaV",(deltaVel))
  //console.log("armvelocity",(arm_velocity))
//console.log("weight",(weight_torque))
